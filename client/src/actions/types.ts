...
export const SEND_TEST_CHAT_MESSAGE = 'SEND_TEST_CHAT_MESSAGE';
export const SEND_TEST_CHAT_MESSAGE_DONE = 'SEND_TEST_CHAT_MESSAGE_DONE';
export const SEND_TEST_CHAT_MESSAGE_FAIL = 'SEND_TEST_CHAT_MESSAGE_FAIL';
